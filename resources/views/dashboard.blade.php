                        ...
                        <div class='mt-5'>
                            ...
                            <div class="rounded-xl border p-5 mt-5 shadow-md w-9/12 bg-white">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <div>
                                        <div class="border m-6 p-6 rounded hover:bg-gray-300 transition cursor-pointer flex flex-col items-center">
                                ...
                                @if($application->answer()->exists())
                                    <hr/>
                                    <h3 class="text-xs font-bold mt-2 italic text-indigo-400">Answers:</h3>
                                    <p>{{$application->answer->body}}</p>
                                @else
                                    <div class="flex justify-end">
                                        <a
                                            href="{{route('answers.create', ['application'=> $application->id])}}"
                                            type="button"
